...
resource "null_resource" "update_ip_external_gw_3" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "echo \"            mtu: ${var.vcenter.dvs.portgroup.nsx_overlay.mtu}\" | sudo tee -a ${var.external_gw.netplanFile}",
      ...
      "echo \"            mtu: ${var.vcenter.dvs.portgroup.nsx_overlay_edge.mtu}\" | sudo tee -a ${var.external_gw.netplanFile}",
